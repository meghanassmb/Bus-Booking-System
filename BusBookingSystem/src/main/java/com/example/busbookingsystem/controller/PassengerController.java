...
public class PassengerController {
	...
	public List<Passenger> getPassengerBySourceAndDestination(@PathVariable String source,
			@PathVariable String destination) {
		return passengerService.findBySourceAndDestination(source, destination);

	}

	@GetMapping("/{arrivalDateTime}")
	public List<Passenger> getPassengerByArrivalDateTime(@PathVariable LocalDateTime arrivalDateTime) {
		return passengerService.findByArrivalDateTime(arrivalDateTime);
